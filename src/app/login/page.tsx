            ...
            <div className="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex min-h-[600px]">
                ...
                <div className="hidden md:flex w-1/2 bg-[#0F172A] relative flex-col justify-between p-12 text-white overflow-hidden">
                    ...
                    <div className="relative z-10 space-y-4 text-sm text-gray-400">
                        <p>"The only real estate OS you will ever need."</p>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-[#D4AF37] transition-all text-sm text-[#0F172A]"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <Link href="#" className="text-xs font-bold text-[#D4AF37] hover:underline">Forgot?</Link>
                            </div>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-[#D4AF37] transition-all text-sm text-[#0F172A]"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    className="absolute right-4 top-3.5 text-gray-400 hover:text-[#0F172A]"
                                >
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-4 bg-[#0F172A] text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#1e293b] transition-all shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="mt-8 text-center text-sm text-gray-500">
                        ...
                        <Link href="/onboarding/registration" className="font-bold text-[#D4AF37] hover:underline">
                            Create Profile
                        </Link>
                    </div>
